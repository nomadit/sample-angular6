  ...
  return {
    ...
    plugins: [
      ...
      new DefinePlugin({
        ...
        'process.env.JAVA_API_URL': JSON.stringify(METADATA.JAVA_API_URL),
        'process.env.NOTICE_AND_FAQ_URL': JSON.stringify(METADATA.NOTICE_AND_FAQ_URL),
        'process.env.MINER_MANAGER_API_URL': JSON.stringify(METADATA.MINER_MANAGER.API_URL),
        'process.env.MINER_MANAGER_WS_URL': JSON.stringify(METADATA.MINER_MANAGER.WS_URL),
        'process.env.MINER_MANAGER_authKey': JSON.stringify(METADATA.MINER_MANAGER.AUTH_KEY),
      }),
